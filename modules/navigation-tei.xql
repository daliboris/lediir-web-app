...
declare function nav:get-metadata($config as map(*), $root as element(), $field as xs:string) {
    switch ($field)
        ...
        case "language" return
            if($root/tei:teiHeader/tei:profileDesc/tei:langUsage/tei:language) then
             ($root/tei:teiHeader/tei:profileDesc/tei:langUsage/tei:language/@ident) (: language is defined within langUsage element :)
            else
            ($root/tei:text/@xml:lang/string(), $root/@xml:lang/string(), $root/tei:teiHeader/@xml:lang/string(), "en")[1] (: lenguage of the text element is preferred :)
        case "date" return (
