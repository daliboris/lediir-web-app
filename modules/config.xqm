...
declare variable $config:facets := [
    ...
    map {
        ...
        "output": function($label) {
            switch($label)
                case "en" return <pb-i18n key="app.languages.en">English</pb-i18n>
                case "cs" return <pb-i18n key="app.languages.cs">Czech</pb-i18n>
                case "cs-CZ" return <pb-i18n key="app.languages.cs">Czech</pb-i18n>
                case "fa" return <pb-i18n key="app.languages.fa">[Persian]</pb-i18n>
                case "tg" return <pb-i18n key="app.languages.tg">[Tajic]</pb-i18n>
                default return <pb-i18n key="{concat("app.languages.", $label)}">[{$label}]</pb-i18n>
        }
    },
    map {
        "dimension": "objectLanguage",
        "heading": "app.facets.object-language",
        "max": 5,
        "hierarchical": false(),
        "output": function($label) {
            switch($label)
    ...
    map {
        "dimension": "targetLanguage",
        "heading": "app.facets.target-language",
        "max": 5,
        "hierarchical": false(),
        "output": function($label) {
            switch($label)
    ...
    map {
        ...
        "heading": "app.facets.partOfSpeech",
        "max": 5,
        "hierarchical": false(),
        "output": function($label) {
                <pb-i18n key="{concat('dictionary.pos.', $label, '.expand')}">{$label}</pb-i18n>
        }
    },
    map {
        "dimension": "domain",
     ...
     map {
        "dimension": "domainHierarchy",
        "heading": "app.facets.domainHierarchy",
        "max": 5,
        "hierarchical": true()
    },
    map {
        "dimension": "style",
        "heading": "app.facets.style",
        "max": 5,
        "hierarchical": false(),
        "output": function($label) {
                <pb-i18n key="{concat('dictionary.textType.', $label, '.expand')}">{$label}</pb-i18n>
        }
    },
    map {
        "dimension": "polysemy",
    ...
    map {
        "dimension": "complexFormType",
        "heading": "app.facets.complexFormType",
        "max": 5,
        "hierarchical": false()
    }
];
...
declare variable $config:data-exclude := (
    ...
    (: Exclude single document; https://faq.teipublisher.com/templates/secondary-pages/ :)
    doc($config:data-root || "/LeDIIR-about.xml")/tei:TEI
    )
;
...
(:
Identifiers (i.e. values of @xml:id) of main taxonomy 
of semantic categories used in the dictionary
:)
declare variable $config:lex-taxonomy-ids := ('LeDIIR.taxonomy');
...
declare variable $config:corpus-url := "http://unesco.uniba.sk/aranea/run.cgi/first?corpname=AranPers_b&amp;queryselector=lemmarow&amp;default_attr=word&amp;fc_lemword_window_type=both&amp;fc_lemword_wsize=5&amp;fc_lemword_type=all&amp;fc_pos_window_type=both&amp;fc_pos_wsize=5&amp;fc_pos_type=all&amp;gdex_enabled=1&amp;gdexcnt=200&amp;lemma=";
declare variable $config:corpus-url-map := map {
    "redaktor" : "http://unesco.uniba.sk/aranea/run.cgi/first?corpname=AranPers_b&amp;queryselector=lemmarow&amp;default_attr=word&amp;fc_lemword_window_type=both&amp;fc_lemword_wsize=5&amp;fc_lemword_type=all&amp;fc_pos_window_type=both&amp;fc_pos_wsize=5&amp;fc_pos_type=all&amp;gdex_enabled=1&amp;gdexcnt=200&amp;lemma=",
    "host" : "http://unesco.uniba.sk/guest/run.cgi/first?corpname=AranPers_x&amp;queryselector=lemmarow&amp;default_attr=word&amp;fc_lemword_window_type=both&amp;fc_lemword_wsize=5&amp;fc_lemword_type=all&amp;fc_pos_window_type=both&amp;fc_pos_wsize=5&amp;fc_pos_type=all&amp;gdex_enabled=1&amp;gdexcnt=200&amp;lemma="
};